...
import { sefariaLinks } from './sefaria-links.ts';
...
export const adapters: SourceAdapter[] = [sefaria, sefariaLinks, orayta, opensiddur, dictaTalmud, dictaLibrary, hewikisource];
